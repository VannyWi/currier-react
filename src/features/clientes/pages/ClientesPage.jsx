...
function ClientesPage() {
  ...
  return (
    <>
      <PageHeader
        title="Clientes"
        action={canWrite(session.role) ? <button type="button" onClick={() => setCreateModalOpen(true)} className="rounded-lg bg-slate-900 px-4 py-2 font-bold text-white hover:bg-slate-800">Nuevo cliente</button> : null}
      />
